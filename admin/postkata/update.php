...
<body>
    <div class="container mx-auto mt-10">
        <h1 class="text-4xl font-bold text-center mb-10">Edit Image</h1>
        <?php
        include '../../anjay.php';
        ...
        if (isset($_GET['id'])) {
            ...
            if ($result->num_rows == 1) {
                ...
                <form action="update.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
                    <div class="mb-4">
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Produk</label>
                    ...
                    <div class="mb-4">
                        <label for="subtitle" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($image) {
                ...
                $sql = "UPDATE post SET title='$title', subtitle='$subtitle' WHERE id=$id";
