...
<nav
    ...
    <div class="container mx-auto mt-10">
        <h1 class="text-4xl font-bold text-center mb-10">Add Gallery</h1>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
            $sql = "INSERT INTO gallery (image_path) VALUES ('$image')";
            
            if ($conn->query($sql) === TRUE) {
                echo "<script>alert('Gallery uploaded successfully.'); window.location.href='index.php';</script>";
            } else {
