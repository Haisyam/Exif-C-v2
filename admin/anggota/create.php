...
<nav
    ...
    <div class="container mx-auto mt-10">
        <h1 class="text-4xl font-bold text-center mb-10">Add Anggota</h1>
        <form action="create.php" method="POST" enctype="multipart/form-data" class=" p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                <label for="instagram" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username Instagram <span class="text-red-600">*gunakan @</span></label>
                <input type="text" id="instagram" name="instagram" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-4">
    ...
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
            $sql = "INSERT INTO anggota (nama, instagram, image_path) VALUES ('$nama', '$instagram', '$image')";
            
            if ($conn->query($sql) === TRUE) {
                echo "<script>alert('Anggota uploaded successfully.'); window.location.href='index.php';</script>";
            } else {
